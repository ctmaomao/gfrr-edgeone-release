...
import { snapshotDisplayHealth } from './modules/snapshotFreshness.js?v=event-units-1';

const APP_VERSION = 'event-units-1';
...
async function renderLoadedData({ radarData, worldOrderStressData = null, marketPricingMetricsData = null, radarHistoryData = null, oilDirectionalData = null, oilThermalWatchData = null, oilNewsEventWatchData = null }) {
  ...
  try {
    const { renderMacroOverview } = await import('./modules/renderMacroOverview.js?v=event-units-1');
