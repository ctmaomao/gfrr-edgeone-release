...
import { snapshotDisplayHealth } from './modules/snapshotFreshness.js?v=odp-news-source-attribution-3';

const APP_VERSION = 'odp-news-source-attribution-3';
...
async function renderLoadedData({ radarData, worldOrderStressData = null, marketPricingMetricsData = null, radarHistoryData = null, oilDirectionalData = null, oilThermalWatchData = null, oilNewsEventWatchData = null }) {
  ...
  try {
    const { renderMacroOverview } = await import('./modules/renderMacroOverview.js?v=odp-news-source-attribution-3');
