...
import { snapshotDisplayHealth } from './modules/snapshotFreshness.js?v=oil-news-quota-status-1';

const APP_VERSION = 'oil-news-quota-status-1';
...
async function renderLoadedData({ radarData, worldOrderStressData = null, marketPricingMetricsData = null, radarHistoryData = null, oilDirectionalData = null, oilThermalWatchData = null, oilNewsEventWatchData = null }) {
  ...
  try {
    const { renderMacroOverview } = await import('./modules/renderMacroOverview.js?v=oil-news-quota-status-1');
