import { fmtNumSafe, riskColor, trendClass } from './config.js?v=score-hardening-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=score-hardening-1';
