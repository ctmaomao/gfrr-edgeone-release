import { fmtNumSafe, riskColor, trendClass } from './config.js?v=snapshot-age-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=snapshot-age-1';
