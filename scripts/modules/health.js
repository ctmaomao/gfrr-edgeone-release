import { fmtNumSafe, riskColor, trendClass } from './config.js?v=score-explanation-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=score-explanation-1';
