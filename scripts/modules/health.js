import { fmtNumSafe, riskColor, trendClass } from './config.js?v=acled-evidence-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=acled-evidence-1';
