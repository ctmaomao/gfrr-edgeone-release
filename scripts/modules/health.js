import { fmtNumSafe, riskColor, trendClass } from './config.js?v=editorial-history-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=editorial-history-1';
