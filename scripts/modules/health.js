import { fmtNumSafe, riskColor, trendClass } from './config.js?v=event-units-1';
import { classifyFreshnessLevel, computeAgeMinutes } from './freshness.js?v=event-units-1';
