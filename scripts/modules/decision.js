import { fmtNumSafe, fmtDeltaSafe, trendClass, riskColor } from './config.js?v=world-order-evidence-1';
import { formatOnRrpYiUsd } from './format.js?v=world-order-evidence-1';
